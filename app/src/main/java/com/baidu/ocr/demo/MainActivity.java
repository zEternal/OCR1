...
public class MainActivity extends AppCompatActivity {
    ...
    private void initAccessTokenWithAkSk() {
        ...
        }, getApplicationContext(),  "PKIO9Q9BkN5ClLhGumXHkBEX", "w4tRO6K4OArYz6rtRtnF1mo7FHbV2Ojj");
    }
                    ...
                    new RecognizeService.ServiceListener() {
                        ...
                        public void onResult(String result) {
                            ...
                            try {
                                ...
                                JSONObject words_result = js.getJSONObject("words_result");
                                color = words_result.getString("color");
                                number = words_result.getString("number");
                            ...
                            //发送车牌号到控制中心
                            try {
                                Socket socket = new Socket("192.168.43.49",8080);
                                OutputStream os = socket.getOutputStream();
                                os.write(number.getBytes());
                                //os.write(number.toString().getBytes());
                                os.flush();
                                os.close();
                                socket.close();
                            } catch (IOException e) {
                            ...
                            //在手机上显示
                            infoPopText("车牌识别     "+"颜色："+color+"车牌号："+number);
                            //infoPopText(result);
                        }
                    });
        }
